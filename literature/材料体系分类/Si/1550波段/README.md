...
> 整理日期:2026-09-03(初版)/ 2026-09-07(增补 B9 + 全 30 篇 SCI 分区列)/ 2026-09-08(增补 A9、A10 两篇,并补齐两篇阅读笔记)/ 2026-09-09(增补 C7、A11、D8、D9 与 E1；使用正式期刊 PDF 复核 C2)。现有原文均已补上**年份 · 期刊**标签和项目笔记;PDF 统一采用 `编号_第一作者_年份_短标题.pdf`。
...
- PDF 审计(2026-09-09):专题目录检出 **32 份** PDF(A1–A6、A9–A11、B1–B5/B8/B9、C1–C7、D1–D9),项目根文献已有 A8(L02)1 份,合计 **33 份**在库。A7、B6、B7 仍待补档；E1 已完成原文精读和笔记，但用户提供的 APS 排版 PDF 未标注 CC BY，未提交到公开仓库。C2 已用正式期刊版复核，仓库仍保留同篇论文的合法 OA arXiv 版。
...
| 编号 | SCI 分区 | 年份 · 期刊 | 文献与 DOI | 本地 PDF | 笔记 |
| --- | --- | --- | --- | --- | --- |
| E1 | 分区待统一核验 | **2025 · Physical Review Materials 9, 105602** | Molina-Ruiz *et al.*, *Revealing the role of hydrogen in reducing optical absorption and mechanical loss in magnetron-sputtered amorphous silicon for gravitational-wave detectors*;[DOI](https://doi.org/10.1103/5n1c-tjhq) | 未公开归档（出版社 PDF 无明确 CC 许可） | [阅读笔记](阅读笔记_E1_Molina_Ruiz_2025.md) |
...
6. **条目与分区口径**:本专题现有 37 条记录，其中 33 份 PDF 已在项目内可用；A7、B6、B7 待补合法原文，E1 因出版社 PDF 无明确 CC 许可仅公开题录与精读笔记。器件文献的分区只用于初筛；E1 暂标“分区待统一核验”，避免把未经统一年份/学科口径核验的分区写成定论。
