...
- 文件名:笔记统一为 `阅读笔记_编号_第一作者_年份.md`;PDF 补档后放 `pdfs/`,命名 `编号_第一作者_年份_短标题.pdf`(ASCII)。
- 年份 · 期刊:均经 CrossRef 核实卷(期)/页码或文章号;预印本用 arXiv 号。
- 交叉引用:与项目已有文献重复的(L01/L02/L03/F-01、Si 专题 B2)不重复入库,仅登记链接。
- 笔记口径:现阶段为**题录+摘要级预备笔记**;补入原文前,笔记中的参数不得直接进入仿真规格。

## A 组|SiN 波导集成 / 片上辐射

| 编号 | 年份 · 期刊 | 文献与 DOI | 本地 PDF | 笔记 |
| --- | --- | --- | --- | --- |
| ★A1 | **2023 · Nature Nanotechnology 18(6), 580–588** | Huang *et al.*, *Leaky-wave metasurfaces for integrated photonics*;[DOI](https://doi.org/10.1038/s41565-023-01360-z) | 项目主文献 L01([笔记](../../../阅读笔记_L01_Huang_2023.md)) | [阅读笔记](阅读笔记_A1_Huang_2023.md) |
| A2 | **2017 · Optics Letters 42(1), 21–24** | Poulton *et al.*, *Large-scale silicon nitride nanophotonic phased arrays at infrared and visible wavelengths*;[DOI](https://doi.org/10.1364/OL.42.000021) | 待补档 | [阅读笔记](阅读笔记_A2_Poulton_2017.md) |
| A3 | **2016 · Journal of Lightwave Technology 34(21), 4864–4871** | Zhao *et al.*, *Experimental Demonstration of Directive Si₃N₄ Optical Leaky Wave Antennas With Semiconductor Perturbations*;[DOI](https://doi.org/10.1109/JLT.2016.2608801) | 待补档 | [阅读笔记](阅读笔记_A3_Zhao_2016.md) |
| A4 | **2022 · Scientific Reports 12, 18759** | Bhandari *et al.*, *Dispersive silicon–nitride optical phased array incorporating arrayed waveguide delay lines for passive line beam scanning*;[DOI](https://doi.org/10.1038/s41598-022-23456-7) | 待补档 | [阅读笔记](阅读笔记_A4_Bhandari_2022.md) |
| A5 | **2024 · Optics Express 32(25), 43778–43787** | Arsanjani *et al.*, *Two dimensional beam forming and steering based on silicon nitride 1×32 optical phased array*;[DOI](https://doi.org/10.1364/OE.534684) | 待补档 | [阅读笔记](阅读笔记_A5_Arsanjani_2024.md) |
| A6 | **2025 · APL Photonics 10(5), 056110** | Jiao *et al.*, *Two-dimensional multi-beam steering for parallel free-space optical communication based on a silicon nitride optical phase array*;[DOI](https://doi.org/10.1063/5.0264068) | 待补档 | [阅读笔记](阅读笔记_A6_Jiao_2025.md) |
| A7 | **2020 · Science Advances 6, eabb4142** | Guo *et al.*, *Molding free-space light with guided wave-driven metasurfaces*;[DOI](https://doi.org/10.1126/sciadv.abb4142) | 项目主文献 L02(SiN 波导 + Au/SiO₂/Au 元原子) | [阅读笔记](阅读笔记_A7_Guo_2020.md) |

## B 组|高 Q / qBIC / BIC

| 编号 | 年份 · 期刊 | 文献与 DOI | 本地 PDF | 笔记 |
| --- | --- | --- | --- | --- |
| ★B1 | **2024 · Nature 626, 765–771** | Schiattarella *et al.*, *Directive giant upconversion by supercritical bound states in the continuum*;[DOI](https://doi.org/10.1038/s41586-023-06967-9) | 待补档 | [阅读笔记](阅读笔记_B1_Schiattarella_2024.md) |
| B2 | **2019 · Nature Photonics 13(6), 390–396** | Yesilkoy *et al.*, *Ultrasensitive hyperspectral imaging and biodetection enabled by dielectric metasurfaces*;[DOI](https://doi.org/10.1038/s41566-019-0394-6) | 待补档 | [阅读笔记](阅读笔记_B2_Yesilkoy_2019.md) |
| B3 | **2026 · Nano Letters(DUV 晶圆级 qBIC)** | Beisenova *et al.*, *Wafer-Scale All-Dielectric Quasi-BIC Metasurfaces*(arXiv:2510.15135);[arXiv](https://arxiv.org/abs/2510.15135) | 项目已有 F-01([笔记](../../../Q1_工艺_L01相关/阅读笔记_F_01_Yesilkoy_2026.md)) | [阅读笔记](阅读笔记_B3_Beisenova_2025.md) |
| B4 | **2024 · Optics Express 32(22), 39906–39916** | Zhang *et al.*, *Optical trapping using quasi-bound states in the continuum of photonic crystal slab*;[DOI](https://doi.org/10.1364/OE.537544) | 待补档 | [阅读笔记](阅读笔记_B4_Zhang_2024.md) |
| B5 | **2025 · Nano Letters 25(7), 2777–2784** | Watanabe *et al.*, *Low-Contrast BIC Metasurfaces with Quality Factors Exceeding 100,000*;[DOI](https://doi.org/10.1021/acs.nanolett.4c05880) | Si 专题 B2 已入库(SiN/石英低对比平台) | [阅读笔记](阅读笔记_B5_Watanabe_2025.md) |
...
1. **折射率对比**:Si(n≈3.48)vs SiN(n≈2.0)。SiN 单元对光场束缚更弱、Q 更低但带宽更大、容差更友好;L01 选择 SiN 正是看中其低损耗 + 弱约束导模(对超表面扰动敏感,利于漏波辐射)。
