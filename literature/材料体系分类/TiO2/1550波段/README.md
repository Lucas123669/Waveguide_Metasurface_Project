...
> **分类口径**：T1–T6 是本专题的历史架位码；文献可同时属于多个材料、波段与主题。跨目录引用请写成 `TiO2-1550:T1`。完整规则见 [多维分类索引](../../../多维分类索引.md)。
...
| --- | --- | --- | --- | --- | --- |
| T1 | **2019 · Applied Optics 58(6), 1460–1466** | Bayati *et al.*, *Role of refractive index in metalens performance*；[DOI](https://doi.org/10.1364/AO.58.001460) | 1550 nm；数值对照 | TiO₂（n=2.4）与 Si/GaN/SiN 等统一口径比较；给出 TiO₂ 元胞初值 | [PDF](pdfs/T1_Bayati_2019_Refractive_Index_Metalens_Performance.pdf) · [规范笔记](精读笔记_T1_Bayati_2019_构思结构与术语.md) |
...
- **T6 的加工路线（2026-09-11 补）**：其支持信息 **Figure S9** 给出"反图形 EBL（ZEP 520A，150 kV）→ **ALD 沉积 TiO₂ 填孔** → **RIE 回刻** → 去胶"的 **加法**路线，是四类材料加工对比中 TiO₂ 的代表（衬底为 Al₂O₃/sapphire + 键合 MQW，**不是熔融石英**）；对比表与截图见 [四类材料加工工艺路线对比](../../../../docs/reports/fabrication/2026-09-11_四类材料加工工艺路线对比.md)（汇报稿第 10 页）。该图为期刊支持信息（**非 OA**），仅限当前 Private 仓库。
