...
本文件夹单独存放**一区/顶级期刊、与 L01（Huang 2023, *Leaky-wave metasurfaces for integrated photonics*）强相关的设计与工艺文献**，与 `literature\` 中原有 L01–L05 系列位置区分。
...
| Q1-06 | Overvig 2020（arXiv 预印本） | ✅ 已下载 |
...
- 设计阶段：先读 Q1-01/Q1-05/Q1-06（BIC 物理与选择定则）→ 再读 Q1-08/Q1-09（泄漏波与逆设计）。
- 工艺阶段：必读 Q1-11（制造鲁棒性），配合 Q1-04（merged BIC 鲁棒设计）与 notes\2026-08-24_PMMA胶材与剂量建议.md。
- 中文快速入门：Q1-07。
