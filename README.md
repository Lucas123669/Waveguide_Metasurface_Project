...
- 1550 nm玻璃基材料汇报：新增 `docs/reports/fabrication/2026-09-09_1550nm玻璃基超表面材料选型与工艺路线.md`，在HPFS 7980、`L≤250 mm`、`t≥300 μm`约束下比较Si/Si₃N₄/TiO₂/PMMA，给出Si主路线、证据边界、逐页讲稿与实验验证关口。
...
- Si 1550 nm 专题：37 条文献记录均已提供年份/期刊标注和项目笔记；仓库 PDF 33 篇（专题目录 32 篇 + 复用 L02 1 篇）。A7、B6、B7 待补合法原文；E1 已精读，但出版社 PDF 未标注 CC 许可，公开仓库仅收录题录和笔记。C2 已用正式期刊版复核，仓库继续保留合法 OA arXiv 版。专题索引见 `literature/材料体系分类/Si/1550波段/README.md`。
