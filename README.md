...
- Si 1550 nm 专题：37 条文献记录均已提供年份/期刊标注和项目笔记；仓库 PDF 34 篇（专题目录 33 篇 + 复用 L02 1 篇），A7、B6、B7 待补原文。2026-09-09 在仓库改为 Private 后补入 E1 出版社 PDF，并以正式期刊版替换 C2；两份文件在仓库重新公开前必须复核或移除。专题索引见 `literature/材料体系分类/Si/1550波段/README.md`。
