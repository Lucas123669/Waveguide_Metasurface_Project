...
报告按“待咨询事项、设计依据、仿真证据、加工沟通、文献分析”分层；带日期文件表示当时的阶段性结论，未带日期文件多为持续维护的技术说明。

## consultation｜待咨询与外部确认

| 文件 | 内容 |
| --- | --- |
| [2026-09-14_EBL加工与仿真设备咨询问题清单.md](consultation/2026-09-14_EBL加工与仿真设备咨询问题清单.md) | EBL 防充电、邻近效应、PMMA、跨写场与仿真软件/设备问题；含优先级、回填表和决策门 |
...
| [2026-09-11_熔融石英与SiO2术语差别.md](fabrication/2026-09-11_熔融石英与SiO2术语差别.md) | **熔融石英 ≠ 泛指的 SiO₂**：合成熔融石英 / 天然熔融石英 / 低 OH 石英 / 石英单晶 / 热氧化 SiO₂（SOI 的 BOX）/ CVD 氧化硅 / 普通玻璃的术语、制备、纯度、厚度能力与 1550 nm 折射率对照表；本项目"必须是熔融石英"的五条理由；三条文献引用口径（支撑汇报稿第 2 页"术语澄清"块） |
| [2026-09-21_HPFS7980衬底面积与采购建议.md](fabrication/2026-09-21_HPFS7980衬底面积与采购建议.md) | 由项目文献中的 0.4–4 mm 有效孔径反推常规采购面积：推荐 20×20 mm（4 cm²）方片，设备要求整片时采用 D100；含厚度、数量、验收字段与手册证据边界 |

## literature｜文献分析

| 文件 | 内容 |
| --- | --- |
| [2026-09-14_近期相关文献筛选与项目影响.md](literature/2026-09-14_近期相关文献筛选与项目影响.md) | 2024–2026 近期文献检索、DOI 去重与四篇入选工作；落到 Jones 矩阵、级联 qBIC、E-Spacer/PMMA 和多模仿真需求 |
