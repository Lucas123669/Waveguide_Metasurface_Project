...
- `experiments/l02_guo_2020/beam_deflector/right45_15cells_air2x/guided_wave_metasurface_45deg_solved.mph` (generated locally and intentionally excluded from GitHub because it is 923 MB)
...
..\bilayer-grating-workflow\bilayer-grating-workflow\.venv\Scripts\python.exe scripts\run_45deg_comsol.py `
  ...
  --output experiments\l02_guo_2020\beam_deflector\right45_15cells_air2x
```
