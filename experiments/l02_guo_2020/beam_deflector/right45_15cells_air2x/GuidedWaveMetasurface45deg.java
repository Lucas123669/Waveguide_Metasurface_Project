/*
 * GuidedWaveMetasurface45deg.java
 */

import com.comsol.model.*;
import com.comsol.model.util.*;

/** Model exported on Aug 26 2026, 13:48 by COMSOL 6.3.0.290. */
public class GuidedWaveMetasurface45deg {

  public static Model run() {
    Model model = ModelUtil.create("Model");

    model
         .modelPath("D:\\xgxz333\\workspace\\graduate\\AI4COMSOL\\Code\\comsol-workflow-master\\guided-wave-metasurface-workflow\\comsol_models\\beam_deflector_right45_15cells_air2x");

    model.label("guided_wave_metasurface_45deg");
    ...
    model.param().set("sub_h", "0.4[um]", "modeled Si handle thickness");
    model.param().set("Lambda", "0.8973309975091556[um]", "three-atom supercell period");
    model.param().set("atom_pitch", "Lambda/3", "meta-atom center spacing");
    model.param().set("n_cells", "15", "number of modeled supercells");
    model.param().set("array_L", "n_cells*Lambda", "metasurface length");
    model.param().set("port_buffer", "1.5[um]", "bare waveguide at each end");
    model.param().set("device_L", "array_L+2*port_buffer", "total modeled length");
    model.param().set("domain_w", "2.0[um]", "transverse domain width");
    model.param().set("air_h", "3.6[um]", "air height above BOX");
    model.param().set("monitor_z", "2.5[um]", "monitor height above antenna");
    ...
    model.param().set("mesh_bulk", "0.25[um]", "air-domain mesh maximum");
    model.param().set("mesh_sio2", "0.15[um]", "SiO2 mesh maximum");
    model.param().set("mesh_si", "0.055[um]", "silicon mesh maximum");
    model.param().set("mesh_metal", "0.02[um]", "local antenna mesh maximum");
  ...
  public static Model run3(Model model) {
    ...
    model.component("comp1").geom("geom1").create("au_b_036", "Block");
    model.component("comp1").geom("geom1").feature("au_b_036").label("atom 036 bottom Au phase p");
    model.component("comp1").geom("geom1").feature("au_b_036").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_036")
         .set("pos", new String[]{"array_x0+(36+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_036").set("size", new String[]{"lx_p", "ly_p", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_036").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_036", "Block");
    model.component("comp1").geom("geom1").feature("sp_036").label("atom 036 SiO2 spacer phase p");
    model.component("comp1").geom("geom1").feature("sp_036").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_036")
         .set("pos", new String[]{"array_x0+(36+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_036").set("size", new String[]{"lx_p", "ly_p", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_036").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_036", "Block");
    model.component("comp1").geom("geom1").feature("au_t_036").label("atom 036 top Au phase p");
    model.component("comp1").geom("geom1").feature("au_t_036").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_036")
         .set("pos", new String[]{"array_x0+(36+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_036").set("size", new String[]{"lx_p", "ly_p", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_036").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_037", "Block");
    model.component("comp1").geom("geom1").feature("au_b_037").label("atom 037 bottom Au phase z");
    model.component("comp1").geom("geom1").feature("au_b_037").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_037")
         .set("pos", new String[]{"array_x0+(37+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_037").set("size", new String[]{"lx_z", "ly_z", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_037").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_037", "Block");
    model.component("comp1").geom("geom1").feature("sp_037").label("atom 037 SiO2 spacer phase z");
    model.component("comp1").geom("geom1").feature("sp_037").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_037")
         .set("pos", new String[]{"array_x0+(37+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_037").set("size", new String[]{"lx_z", "ly_z", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_037").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_037", "Block");
    model.component("comp1").geom("geom1").feature("au_t_037").label("atom 037 top Au phase z");
    model.component("comp1").geom("geom1").feature("au_t_037").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_037")
         .set("pos", new String[]{"array_x0+(37+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_037").set("size", new String[]{"lx_z", "ly_z", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_037").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_038", "Block");
    model.component("comp1").geom("geom1").feature("au_b_038").label("atom 038 bottom Au phase m");
    model.component("comp1").geom("geom1").feature("au_b_038").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_038")
         .set("pos", new String[]{"array_x0+(38+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_038").set("size", new String[]{"lx_m", "ly_m", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_038").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_038", "Block");
    model.component("comp1").geom("geom1").feature("sp_038").label("atom 038 SiO2 spacer phase m");
    model.component("comp1").geom("geom1").feature("sp_038").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_038")
         .set("pos", new String[]{"array_x0+(38+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_038").set("size", new String[]{"lx_m", "ly_m", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_038").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_038", "Block");
    model.component("comp1").geom("geom1").feature("au_t_038").label("atom 038 top Au phase m");
    model.component("comp1").geom("geom1").feature("au_t_038").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_038")
         .set("pos", new String[]{"array_x0+(38+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_038").set("size", new String[]{"lx_m", "ly_m", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_038").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_039", "Block");
    model.component("comp1").geom("geom1").feature("au_b_039").label("atom 039 bottom Au phase p");
    model.component("comp1").geom("geom1").feature("au_b_039").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_039")
         .set("pos", new String[]{"array_x0+(39+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_039").set("size", new String[]{"lx_p", "ly_p", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_039").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_039", "Block");
    model.component("comp1").geom("geom1").feature("sp_039").label("atom 039 SiO2 spacer phase p");
    model.component("comp1").geom("geom1").feature("sp_039").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_039")
         .set("pos", new String[]{"array_x0+(39+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_039").set("size", new String[]{"lx_p", "ly_p", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_039").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_039", "Block");
    model.component("comp1").geom("geom1").feature("au_t_039").label("atom 039 top Au phase p");
    model.component("comp1").geom("geom1").feature("au_t_039").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_039")
         .set("pos", new String[]{"array_x0+(39+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_039").set("size", new String[]{"lx_p", "ly_p", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_039").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_040", "Block");
    model.component("comp1").geom("geom1").feature("au_b_040").label("atom 040 bottom Au phase z");
    model.component("comp1").geom("geom1").feature("au_b_040").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_040")
         .set("pos", new String[]{"array_x0+(40+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_040").set("size", new String[]{"lx_z", "ly_z", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_040").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_040", "Block");
    model.component("comp1").geom("geom1").feature("sp_040").label("atom 040 SiO2 spacer phase z");
    model.component("comp1").geom("geom1").feature("sp_040").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_040")
         .set("pos", new String[]{"array_x0+(40+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_040").set("size", new String[]{"lx_z", "ly_z", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_040").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_040", "Block");
    model.component("comp1").geom("geom1").feature("au_t_040").label("atom 040 top Au phase z");
    model.component("comp1").geom("geom1").feature("au_t_040").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_040")
         .set("pos", new String[]{"array_x0+(40+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_040").set("size", new String[]{"lx_z", "ly_z", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_040").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_041", "Block");
    model.component("comp1").geom("geom1").feature("au_b_041").label("atom 041 bottom Au phase m");
    model.component("comp1").geom("geom1").feature("au_b_041").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_041")
         .set("pos", new String[]{"array_x0+(41+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_041").set("size", new String[]{"lx_m", "ly_m", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_041").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_041", "Block");
    model.component("comp1").geom("geom1").feature("sp_041").label("atom 041 SiO2 spacer phase m");
    model.component("comp1").geom("geom1").feature("sp_041").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_041")
         .set("pos", new String[]{"array_x0+(41+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_041").set("size", new String[]{"lx_m", "ly_m", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_041").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_041", "Block");
    model.component("comp1").geom("geom1").feature("au_t_041").label("atom 041 top Au phase m");
    model.component("comp1").geom("geom1").feature("au_t_041").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_041")
         .set("pos", new String[]{"array_x0+(41+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_041").set("size", new String[]{"lx_m", "ly_m", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_041").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_042", "Block");
    model.component("comp1").geom("geom1").feature("au_b_042").label("atom 042 bottom Au phase p");
    model.component("comp1").geom("geom1").feature("au_b_042").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_042")
         .set("pos", new String[]{"array_x0+(42+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_042").set("size", new String[]{"lx_p", "ly_p", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_042").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_042", "Block");
    model.component("comp1").geom("geom1").feature("sp_042").label("atom 042 SiO2 spacer phase p");
    model.component("comp1").geom("geom1").feature("sp_042").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_042")
         .set("pos", new String[]{"array_x0+(42+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_042").set("size", new String[]{"lx_p", "ly_p", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_042").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_042", "Block");
    model.component("comp1").geom("geom1").feature("au_t_042").label("atom 042 top Au phase p");
    model.component("comp1").geom("geom1").feature("au_t_042").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_042")
         .set("pos", new String[]{"array_x0+(42+0.5)*atom_pitch-lx_p/2", "-ly_p/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_042").set("size", new String[]{"lx_p", "ly_p", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_042").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_043", "Block");
    model.component("comp1").geom("geom1").feature("au_b_043").label("atom 043 bottom Au phase z");
    model.component("comp1").geom("geom1").feature("au_b_043").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_043")
         .set("pos", new String[]{"array_x0+(43+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_043").set("size", new String[]{"lx_z", "ly_z", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_043").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_043", "Block");
    model.component("comp1").geom("geom1").feature("sp_043").label("atom 043 SiO2 spacer phase z");
    model.component("comp1").geom("geom1").feature("sp_043").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_043")
         .set("pos", new String[]{"array_x0+(43+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_043").set("size", new String[]{"lx_z", "ly_z", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_043").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_043", "Block");
    model.component("comp1").geom("geom1").feature("au_t_043").label("atom 043 top Au phase z");
    model.component("comp1").geom("geom1").feature("au_t_043").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_043")
         .set("pos", new String[]{"array_x0+(43+0.5)*atom_pitch-lx_z/2", "-ly_z/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_043").set("size", new String[]{"lx_z", "ly_z", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_043").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_b_044", "Block");
    model.component("comp1").geom("geom1").feature("au_b_044").label("atom 044 bottom Au phase m");
    model.component("comp1").geom("geom1").feature("au_b_044").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_b_044")
         .set("pos", new String[]{"array_x0+(44+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h"});
    model.component("comp1").geom("geom1").feature("au_b_044").set("size", new String[]{"lx_m", "ly_m", "t_au"});
    model.component("comp1").geom("geom1").feature("au_b_044").set("selresult", true);
    model.component("comp1").geom("geom1").create("sp_044", "Block");
    model.component("comp1").geom("geom1").feature("sp_044").label("atom 044 SiO2 spacer phase m");
    model.component("comp1").geom("geom1").feature("sp_044").set("base", "corner");
    model.component("comp1").geom("geom1").feature("sp_044")
         .set("pos", new String[]{"array_x0+(44+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h+t_au"});
    model.component("comp1").geom("geom1").feature("sp_044").set("size", new String[]{"lx_m", "ly_m", "t_d"});
    model.component("comp1").geom("geom1").feature("sp_044").set("selresult", true);
    model.component("comp1").geom("geom1").create("au_t_044", "Block");
    model.component("comp1").geom("geom1").feature("au_t_044").label("atom 044 top Au phase m");
    model.component("comp1").geom("geom1").feature("au_t_044").set("base", "corner");
    model.component("comp1").geom("geom1").feature("au_t_044")
         .set("pos", new String[]{"array_x0+(44+0.5)*atom_pitch-lx_m/2", "-ly_m/2", "wg_h+t_au+t_d"});
    model.component("comp1").geom("geom1").feature("au_t_044").set("size", new String[]{"lx_m", "ly_m", "t_au"});
    model.component("comp1").geom("geom1").feature("au_t_044").set("selresult", true);
    ...
    model.component("comp1").selection("sel_si").set("input", new String[]{"geom1_waveguide_dom"});
    ...
    model.component("comp1").selection("sel_au")
         ...
         "geom1_au_b_030_dom", "geom1_au_b_031_dom", "geom1_au_b_032_dom", "geom1_au_b_033_dom", "geom1_au_b_034_dom", "geom1_au_b_035_dom", "geom1_au_b_036_dom", "geom1_au_b_037_dom", "geom1_au_b_038_dom", "geom1_au_b_039_dom", 
         "geom1_au_b_040_dom", "geom1_au_b_041_dom", "geom1_au_b_042_dom", "geom1_au_b_043_dom", "geom1_au_b_044_dom", "geom1_au_t_000_dom", "geom1_au_t_001_dom", "geom1_au_t_002_dom", "geom1_au_t_003_dom", "geom1_au_t_004_dom", 
         "geom1_au_t_005_dom", "geom1_au_t_006_dom", "geom1_au_t_007_dom", "geom1_au_t_008_dom", "geom1_au_t_009_dom", "geom1_au_t_010_dom", "geom1_au_t_011_dom", "geom1_au_t_012_dom", "geom1_au_t_013_dom", "geom1_au_t_014_dom", 
         "geom1_au_t_015_dom", "geom1_au_t_016_dom", "geom1_au_t_017_dom", "geom1_au_t_018_dom", "geom1_au_t_019_dom", "geom1_au_t_020_dom", "geom1_au_t_021_dom", "geom1_au_t_022_dom", "geom1_au_t_023_dom", "geom1_au_t_024_dom", 
         "geom1_au_t_025_dom", "geom1_au_t_026_dom", "geom1_au_t_027_dom", "geom1_au_t_028_dom", "geom1_au_t_029_dom", "geom1_au_t_030_dom", "geom1_au_t_031_dom", "geom1_au_t_032_dom", "geom1_au_t_033_dom", "geom1_au_t_034_dom", 
         "geom1_au_t_035_dom", "geom1_au_t_036_dom", "geom1_au_t_037_dom", "geom1_au_t_038_dom", "geom1_au_t_039_dom", "geom1_au_t_040_dom", "geom1_au_t_041_dom", "geom1_au_t_042_dom", "geom1_au_t_043_dom", "geom1_au_t_044_dom"});
    ...
    model.component("comp1").selection("sel_sio2")
         ...
         "geom1_sp_029_dom", "geom1_sp_030_dom", "geom1_sp_031_dom", "geom1_sp_032_dom", "geom1_sp_033_dom", "geom1_sp_034_dom", "geom1_sp_035_dom", "geom1_sp_036_dom", "geom1_sp_037_dom", "geom1_sp_038_dom", 
         "geom1_sp_039_dom", "geom1_sp_040_dom", "geom1_sp_041_dom", "geom1_sp_042_dom", "geom1_sp_043_dom", "geom1_sp_044_dom"});
    ...
    model.component("comp1").selection("sel_atoms")
         ...
         "geom1_sp_033_dom", "geom1_au_t_033_dom", "geom1_au_b_034_dom", "geom1_sp_034_dom", "geom1_au_t_034_dom", "geom1_au_b_035_dom", "geom1_sp_035_dom", "geom1_au_t_035_dom", "geom1_au_b_036_dom", "geom1_sp_036_dom", 
         "geom1_au_t_036_dom", "geom1_au_b_037_dom", "geom1_sp_037_dom", "geom1_au_t_037_dom", "geom1_au_b_038_dom", "geom1_sp_038_dom", "geom1_au_t_038_dom", "geom1_au_b_039_dom", "geom1_sp_039_dom", "geom1_au_t_039_dom", 
         "geom1_au_b_040_dom", "geom1_sp_040_dom", "geom1_au_t_040_dom", "geom1_au_b_041_dom", "geom1_sp_041_dom", "geom1_au_t_041_dom", "geom1_au_b_042_dom", "geom1_sp_042_dom", "geom1_au_t_042_dom", "geom1_au_b_043_dom", 
         "geom1_sp_043_dom", "geom1_au_t_043_dom", "geom1_au_b_044_dom", "geom1_sp_044_dom", "geom1_au_t_044_dom"});
  ...
  public static Model run4(Model model) {
    ...
    model.component("comp1").selection("sel_port_in").set("zmin", "-box_h-sel_tol");
    ...
    model.component("comp1").selection("sel_port_out").set("zmin", "-box_h-sel_tol");
    ...
    model.component("comp1").selection("sel_open_bottom").set("zmin", "-box_h-sel_tol");
    model.component("comp1").selection("sel_open_bottom").set("zmax", "-box_h+sel_tol");
    ...
    model.component("comp1").selection("sel_open_ymin").set("zmin", "-box_h-sel_tol");
    ...
    model.component("comp1").selection("sel_open_ymax").set("zmin", "-box_h-sel_tol");
    ...
    model.component("comp1").mesh("mesh1").feature("size").set("hmin", "mesh_metal/3");
    model.component("comp1").mesh("mesh1").create("size_sio2", "Size");
    model.component("comp1").mesh("mesh1").feature("size_sio2").selection().named("sel_sio2");
    model.component("comp1").mesh("mesh1").feature("size_sio2").set("custom", "on");
    model.component("comp1").mesh("mesh1").feature("size_sio2").set("hmax", "mesh_sio2");
    model.component("comp1").mesh("mesh1").feature("size_sio2").set("hmin", "mesh_metal/3");
    model.component("comp1").mesh("mesh1").create("size_si", "Size");
    model.component("comp1").mesh("mesh1").feature("size_si").selection().named("geom1_waveguide_dom");
    model.component("comp1").mesh("mesh1").feature("size_si").set("custom", "on");
    model.component("comp1").mesh("mesh1").feature("size_si").set("hmax", "mesh_si");
    model.component("comp1").mesh("mesh1").feature("size_si").set("hmin", "mesh_metal/3");
    ...
    model.study("std1").create("bmode1", "BoundaryModeAnalysis");
    model.study("std1").feature("bmode1").label("input-port TE00 boundary mode");
    model.study("std1").feature("bmode1").set("PortName", "1");
    model.study("std1").feature("bmode1").set("modeFreq", "freq0");
    model.study("std1").feature("bmode1").set("neigs", "1");
    model.study("std1").feature("bmode1").set("shift", "2.53");
    model.study("std1").create("bmode2", "BoundaryModeAnalysis");
    model.study("std1").feature("bmode2").label("output-port TE00 boundary mode");
    model.study("std1").feature("bmode2").set("PortName", "2");
    model.study("std1").feature("bmode2").set("modeFreq", "freq0");
    model.study("std1").feature("bmode2").set("neigs", "1");
    model.study("std1").feature("bmode2").set("shift", "2.53");
    ...
    model.label("guided_wave_metasurface_45deg_unsolved.mph");
