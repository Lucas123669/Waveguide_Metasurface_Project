...
def main():
    ...
    parser.add_argument("--directory", default=os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "experiments", "l02_guo_2020", "beam_deflector", "right45_15cells_air2x")))
