...
def main():
    ...
    parser.add_argument(
        "--config",
        default=os.path.join(os.path.dirname(__file__), "..", "configs", "seeds", "guo2020_beam_deflector_paper_seed.json"),
    )
    parser.add_argument(
        "--output-dir",
        default=os.path.join(os.path.dirname(__file__), "..", "experiments", "l02_guo_2020", "beam_deflector", "structure"),
    )
