...
def config(name):
    seeds = {"beam_deflector_1550nm.json": "guo2020_beam_deflector_paper_seed.json",
             "metalens_1550nm.json": "guo2020_metalens_1550nm_seed.json"}
    return load_config(os.path.join(os.path.dirname(__file__), "..", "..", "configs", "seeds", seeds[name]))
