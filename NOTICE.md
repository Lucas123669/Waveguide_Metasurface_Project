...
## 3. 供应商与产品资料（references/materials/）

`references/materials/` 下的产品手册、规格书与供应商资料归原权利人所有，不在本项目 MIT 许可范围内。当前 Corning HPFS 产品手册仅供私有项目内部研究、选材与采购沟通；公开发布前应移除文件或取得明确再分发许可，仅保留官方链接和本项目自行撰写的摘要。
