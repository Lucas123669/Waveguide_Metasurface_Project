...
- `gwm_workflow/comsol_mode.py`：二维 SOI 模式模型
- `gwm_workflow/comsol_structure.py`：三维波导驱动超表面模型
...
- `comsol_models/waveguide_mode_1550nm/soi_waveguide_mode.mph`
- `comsol_models/waveguide_mode_1550nm/mode_result.json`
- `comsol_models/beam_deflector_45deg/guided_wave_metasurface_45deg_solved.mph`
- `comsol_models/beam_deflector_45deg/GuidedWaveMetasurface45deg.java`
- `comsol_models/beam_deflector_45deg/simulation_result.json`
- `comsol_models/beam_deflector_45deg/monitor_field_complex.csv`
- `comsol_models/beam_deflector_45deg/angular_spectrum.csv`
- `comsol_models/beam_deflector_45deg/angular_spectrum.png`
- `comsol_models/beam_deflector_45deg/field_xz_normE.png`
- `comsol_models/beam_deflector_45deg/field_xz_Ey_paper_style.png`
- `comsol_models/beam_deflector_45deg/field_xz_Ey_paper_style.pdf`
- `comsol_models/beam_deflector_45deg/field_xz_Ey_complex.npz`
