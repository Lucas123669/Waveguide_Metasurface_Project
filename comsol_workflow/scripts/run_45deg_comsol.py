...
def main():
    ...
    parser.add_argument("--mode-result", default=os.path.join(PROJECT_ROOT, "comsol_models", "waveguide_mode_1550nm", "mode_result.json"))
    parser.add_argument("--output", default=os.path.join(PROJECT_ROOT, "comsol_models", "beam_deflector_45deg"))
